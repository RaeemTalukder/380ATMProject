...
public class AdminAccountViewBuilder extends ViewBuilder {
    ...
    private final Runnable adminOptionsHandler;
    private final Runnable logoutHandler;

    public AdminAccountViewBuilder(Model model, Runnable withdrawHandler, Runnable depositHandler, Runnable adminOptionsHandler, Runnable logoutHandler) {
        super(model);
        this.withdrawHandler = withdrawHandler;
        this.depositHandler = depositHandler;
        this.adminOptionsHandler = adminOptionsHandler;
